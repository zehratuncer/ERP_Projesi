...
public class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    ...
    public static readonly Guid SampleProduct6Id = Guid.Parse("bbbbbbbb-6666-6666-6666-666666666666");
    public static readonly Guid SampleProduct7Id = Guid.Parse("bbbbbbbb-7777-7777-7777-777777777777");
    ...
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        builder.HasData(
            ...
            new Product
            {
                ...
                MinStockLevel = 10,
                UnitPrice = 950.00m,
                SupplierId = SupplierConfiguration.SampleSupplier4Id,
                IsActive = true,
                CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc),
                IsDeleted = false
            },
            new Product
            {
                ...
                MinStockLevel = 10,
                UnitPrice = 175.00m,
                SupplierId = SupplierConfiguration.SampleSupplier5Id,
                IsActive = true,
                CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc),
                IsDeleted = false
            },
